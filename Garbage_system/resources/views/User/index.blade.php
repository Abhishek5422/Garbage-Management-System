...
<link href="{{url('User/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" media="all">
<link href="{{url('User/')}}css/fontawesome-all.min.css" rel="stylesheet" type="text/css" media="all">
<link href="{{url('User/css/easy-responsive-tabs.css')}}" rel='stylesheet' type='text/css'/>
<link rel="stylesheet" href="{{url('User/css/flexslider.css')}}" type="text/css" media="all">
<link rel="stylesheet" type="text/css" href="{{url('User/css/style_common.css')}}" />
<link rel="stylesheet" type="text/css" href="{{url('User/css/style1.css')}}" />
<link href="{{url('User/css/style.css')}}" rel="stylesheet" type="text/css" media="all"/>
<link href="{{url('User///fonts.googleapis.com/css?family=Roboto:400,500,700,900')}}" rel="stylesheet">
<link href="{{url('User///fonts.googleapis.com/css?family=Open+Sans:400,600,700,800')}}" rel="stylesheet">
</head>
<body>
<header>
	<!-- header -->
	<nav class="navbar navbar-expand-lg navbar-light">
  <a class="navbar-brand" href="index.html">Garbage Management System</a>
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{url('customer_login')}}">User</a>
...
<img src="{{url('User/images/bb9.jpg')}}" alt="xt" class="img-fluid">
</div>
...
<div class="slideshow-container">
  ...
  <div class="mySlides">
  <img src="{{url('User/images/test1.jpg')}}" alt="xyt" class="img-fluid">
    <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h4>
    
  </div>

  <div class="mySlides">
  <img src="{{url('User/images/test2.jpg')}}" alt="xyt" class="img-fluid">
    <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h4>
    
  </div>

  <div class="mySlides">
  <img src="{{url('User/images/test3.jpg')}}" alt="xyt" class="img-fluid">
    <h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry</h4>
...
<div class="w3_mg">
<h3>Fast Service</h3>
<p class=" my-lg-4 my-md-3 my-sm-2 my-2">Some of the common waste management services include : Segregation of Waste. Composting and treatment of Organic Waste. Supply of quality waste material to recyclers.</p>
...
<div class="copyright">
		<p>@2024 Garbage Management System | Laravel |<a href="https://atees.org/"> ATEES Industrial Training Pvt Ltd</a></p>
		</div>
	</div>
</section>
<!-- /Footer-->
...
<script  src="{{url('User/js/jquery.min.v3.js')}}"></script>
...
<script  src="{{url('User/js/SmoothScroll.min.js')}}"></script>	
	...
	<script src="{{url('User/js/easy-responsive-tabs.js')}}"></script>
<script>
...
<script type="text/javascript">
				...
				<script type="text/javascript" src="{{url('User/js/jquery.flexisel.js')}}"></script>
					
<!--team-->
<script src="{{url('User/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
 <script>
						$(document).ready(function() {
...
setInterval(changeWord, 4000);
	...
	<!-- //stats -->
<!-- skills -->
<script src="{{url('User/js/skill.bars.jquery.js')}}"></script>
<script>
	$(document).ready(function(){
